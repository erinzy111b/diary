...
class FormBuilder
{
     ...
     * @return \Illuminate\Support\HtmlString
     */
    function label($name, $value = null, $options = [], $escape_html = true)
    {
        $this->labels[] = $name;
     ...
     * @return \Illuminate\Support\HtmlString
     */
    function range($name, $value = null, $options = [])
    {
     ...
     * @return \Illuminate\Support\HtmlString
     */
    function search($name, $value = null, $options = [])
    {
     ...
     * @return \Illuminate\Support\HtmlString
     */
    function tel($name, $value = null, $options = [])
    {
     ...
     * @return \Illuminate\Support\HtmlString
     */
    function date($name, $value = null, $options = [])
    {
     ...
     * @return \Illuminate\Support\HtmlString
     */
    function datetimeLocal($name, $value = null, $options = [])
    {
        if ($value instanceof DateTime) {
     ...
     * @return \Illuminate\Support\HtmlString
     */
    function time($name, $value = null, $options = [])
    {
        if ($value instanceof DateTime) {
     ...
     * @return \Illuminate\Support\HtmlString
     */
    function url($name, $value = null, $options = [])
    {
     ...
     * @return \Illuminate\Support\HtmlString
     */
    function week($name, $value = null, $options = [])
    {
        if ($value instanceof DateTime) {
     ...
     * @return array
     */
    function setTextAreaSize($options)
    {
     ...
     * @return array
     */
    function setQuickTextAreaSize($options)
    {
     ...
     * @return \Illuminate\Support\HtmlString
     */
    function getSelectOption($display, $value, $selected, array $attributes = [], array $optgroupAttributes = [])
    {
     ...
     * @return \Illuminate\Support\HtmlString
     */
    function optionGroup($list, $label, $selected, array $attributes = [], array $optionsAttributes = [], $level = 0)
    {
        $html = [];
     ...
     * @return bool
     */
    function compareValues($name, $value)
    {
     ...
     * @return bool
     */
    function missingOldAndModel($name)
    {
     ...
     * @return \Illuminate\Support\HtmlString
     */
    function month($name, $value = null, $options = [])
    {
        if ($value instanceof DateTime) {
     ...
     * @return string
     */
    function getAction(array $options)
    {
     ...
     * @return string
     */
    function getRouteAction($options)
    {
        if (is_array($options)) {
     ...
     * @return string
     */
    function getControllerAction($options)
    {
        if (is_array($options)) {
     ...
     * @return string
     */
    function getIdAttribute($name, $attributes)
    {
     ...
     * @return mixed
     */
    function getValueAttribute($name, $value = null)
    {
        if (is_null($name)) {
            return $value;
        }
     ...
     * @param bool $consider
     */
    function considerRequest($consider = true)
    {
     ...
     * @return mixed
     */
    function getModelValueAttribute($name)
    {
     ...
     * @return $this
     */
    function setSessionStore(Session $session)
    {
    ...
    // 來源 https: //stackoverflow.com/questions/21977798/laravel-selectrange-with-step-size
    // 直接用 form:: 實現區段選擇，而不需要轉回 php 原生表單寫法

    function selectRangeWithInterval($name, $start, $end, $interval, $default = null, $attributes = [])
    {
        if ($interval == 0) {
